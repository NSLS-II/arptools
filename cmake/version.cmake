...
string(REPLACE "v" "" VERSION_NUMBER "${GIT_VERSION}")
set(VERSION_NUMBER "${VERSION_NUMBER}" CACHE INTERNAL "GIT version")
message(STATUS "CACHE VERSION_NUMBER = ${VERSION_NUMBER}")
